    ...
    return (
        <>
            <header className={`border-b border-neutral-800 fixed top-0 left-0 right-0 bg-neutral-950 z-50 transition-transform duration-300 ${
                ...
                <div className="container mx-auto px-2 md:px-4 py-2 lg:py-3">
                    <div className="flex items-center justify-between">
                        ...
                        >
                            <div className="flex flex-col items-center">
                                ...
                                <span className="text-base text-neutral-300 font-normal whitespace-nowrap tracking-tight">Blockchain Dev &amp; Consulting</span>
                            </div>
                        </Link>
